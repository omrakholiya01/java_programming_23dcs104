...
class solution{
	...
	public static char[][] cTurn(char[][] ttt, char c, char r, int c1, int c2){
		...
		for(int i = 0; i < 3; i++){
			if     (ttt[i][0] == r && ttt[i][1] == r && ttt[i][2] == '.') {ttt[i][2] = r;return ttt;}
			else if(ttt[i][0] == r && ttt[i][2] == r && ttt[i][1] == '.') {ttt[i][1] = r;return ttt;}
			else if(ttt[i][1] == r && ttt[i][2] == r && ttt[i][0] == '.') {ttt[i][0] = r;return ttt;}

			else if(ttt[0][i] == r && ttt[1][i] == r && ttt[2][i] == '.') {ttt[2][i] = r;return ttt;}
			else if(ttt[0][i] == r && ttt[2][i] == r && ttt[1][i] == '.') {ttt[1][i] = r;return ttt;}
			else if(ttt[1][i] == r && ttt[2][i] == r && ttt[0][i] == '.') {ttt[0][i] = r;return ttt;}
		}

		if(ttt[0][0] == r && ttt[1][1] == r && ttt[2][2] == '.') {ttt[2][2] = r;return ttt;}
		if(ttt[0][0] == r && ttt[2][2] == r && ttt[1][1] == '.') {ttt[1][1] = r;return ttt;}
		if(ttt[1][1] == r && ttt[2][2] == r && ttt[0][0] == '.') {ttt[0][0] = r;return ttt;}

		if(ttt[1][1] == r && ttt[2][0] == r && ttt[0][2] == '.') {ttt[0][2] = r;return ttt;}
		if(ttt[2][0] == r && ttt[0][2] == r && ttt[1][1] == '.') {ttt[1][1] = r;return ttt;}
		if(ttt[1][1] == r && ttt[0][2] == r && ttt[2][0] == '.') {ttt[2][0] = r;return ttt;}
